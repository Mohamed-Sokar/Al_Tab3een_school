...
onMounted(async () => {
  ...
  // await employeesStore.fetchAbsenceReports();
  // await employeesStore.fetchLoans();
  // await employeesStore.fetchAdministrativeIssues();
  // await employeesStore.fetchSupervisoryVisits();
});
