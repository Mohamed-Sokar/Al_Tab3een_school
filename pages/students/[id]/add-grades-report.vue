<template>
  <UCard class="max-w-3xl mx-auto mt-15">
    ...
    >
      ...
      <UFormField label="التربية الإسلامية" name="relegion">
        <UInput
          type="number"
          v-model.number="state.relegion"
...
const addReport = async () => {
  ...
  //   relegion: state?.relegion,
  //   type: state?.type,
  //   maxmumGrade: state?.maxmumGrade,
  //   minmumGrade: state?.minmumGrade,
  //   quran: state?.quran,
  //   average: `${Math.round(
  //     (state?.arabic +
  //       state?.math +
