...
import { array, date, object, string, boolean } from "yup";
import {
  courses_options,
  gender_options,
  job_title_options,
...
const schema = object({
  ...
  isShared: boolean().required("تحديد إذا كان الموظف مشترك أم لا مطلوب"),
});
  ...
  <div class="max-w-3xl mx-auto mt-15">
    ...
    <UCard>
      ...
      >
        ...
        <UFormField
          required
          label="تاريخ التسجيل في المدرسة"
        ...
        <UFormField required label="الحالة الاجتماعية" name="marital_status">
          <USelect
        ...
        <UFormField required label="المسمى الوظيفي" name="job_title">
          <USelect
        ...
        <UFormField required label="عدد الأطفال" name="children_count">
          <UInput
        ...
        <UFormField required label="المادة" name="subject">
          <USelect
        ...
        <UFormField required label="الراتب" name="salary">
