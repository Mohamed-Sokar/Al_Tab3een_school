  ...
  setup(__props) {
    ...
    const updateReport = async () => {
      ...
      gradesReports[reportIndex] = {
        ...state,
        average: `${((state == null ? void 0 : state.arabic) + (state == null ? void 0 : state.math) + (state == null ? void 0 : state.science) + (state == null ? void 0 : state.quran) + (state == null ? void 0 : state.english)) / 5}%`
      };
      setTimeout(() => {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_UButton, {
                    ...
                    color: "secondary",
                    onClick: ($event) => ("navigateTo" in _ctx ? _ctx.navigateTo : unref(navigateTo))("/students/view/grades"),
                    label: "\u0625\u0644\u063A\u0627\u0621"
                  }, null, _parent3, _scopeId2));
                  _push3(`</div>`);
                } else {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/students/[id]/edit_grades_report.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=edit_grades_report-zXOL1hOK.mjs.map
