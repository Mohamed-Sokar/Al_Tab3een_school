...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const driver_id = +route.params.id;
    const targetedDriver = driversStore.getSpecificDriver(driver_id);
    Object.assign(state, targetedDriver);
    const onSubmit = async () => {
      await driversStore.updateDriver(driver_id, { ...state });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/drivers/[id]/edit_driver.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=edit_driver-Dvb8edVy.mjs.map
