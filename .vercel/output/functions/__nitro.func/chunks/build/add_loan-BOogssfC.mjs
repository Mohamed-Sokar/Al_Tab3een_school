...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const form = ref();
    let teacher_id = route.params.id instanceof Array ? route.params.id[0] : (_a = route.params.id) != null ? _a : 0;
    const schema = object({
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/teachers/[id]/add_loan.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=add_loan-BOogssfC.mjs.map
