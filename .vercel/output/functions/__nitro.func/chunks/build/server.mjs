import { defineComponent, inject, computed, provide, mergeProps, unref, withCtx, renderSlot, createBlock, openBlock, shallowRef, h, resolveComponent, useSlots, ref, createCommentVNode, toDisplayString, createVNode, Suspense, hasInjectionContext, toRef, isRef, watch, resolveDynamicComponent, toValue, shallowReactive, Fragment, getCurrentInstance, onServerPrefetch, nextTick, createElementBlock, cloneVNode, defineAsyncComponent, useSSRContext, createApp, renderList, useId, onErrorCaptured, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, createTextVNode, withModifiers, getCurrentScope, markRaw } from 'vue';
import { l as serialize, m as isEqual, n as defu, o as parseQuery, q as klona, t as defuFn, v as hasProtocol, w as isScriptProtocol, x as joinURL, y as withQuery, z as sanitizeStatusCode, A as withTrailingSlash, B as withoutTrailingSlash, C as getContext, c as createError$1, $ as $fetch$1, D as baseURL, E as createHooks, F as executeAsync, s as setCookie, a as getHeader, G as toRouteMatcher, H as createRouter$1, I as destr, J as getRequestHeader, K as getCookie, L as deleteCookie } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DKCN_6EV.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./login-J0mwLa5h.mjs')
  },
  {
    name: void 0 ,
    path: "/levels",
    component: () => import('./levels-bizkdKk4.mjs'),
    children: [
      {
        name: "levels-add",
        path: "add",
        component: () => import('./add-B7QsSLFV.mjs')
      },
      {
        name: "levels",
        path: "",
        component: () => import('./index-DMEJqpTD.mjs')
      },
      {
        name: "levels-id-edit_level",
        path: ":id()/edit_level",
        component: () => import('./edit_level-BzD5FAfZ.mjs')
      }
    ]
  },
  {
    name: "reports",
    path: "/reports",
    component: () => import('./reports-CkqUkjaE.mjs')
  },
  {
    name: void 0 ,
    path: "/payments",
    component: () => import('./payments-7SRfBy7g.mjs'),
    children: [
      {
        name: "payments-add",
        path: "add",
        component: () => import('./add-DKPL1kpM.mjs')
      },
      {
        name: "payments",
        path: "",
        component: () => import('./index-CcXaSJId.mjs')
      },
      {
        name: "payments-id-edit_payment",
        path: ":id()/edit_payment",
        component: () => import('./edit_payment-CN5s3yjg.mjs')
      }
    ]
  },
  {
    name: "settings",
    path: "/settings",
    component: () => import('./settings-DJ_jrHqW.mjs'),
    children: [
      {
        name: "settings-avatar",
        path: "avatar",
        component: () => import('./avatar-h99IoZp6.mjs')
      },
      {
        name: "settings-general",
        path: "general",
        component: () => import('./general-Jnx4Hfsv.mjs')
      },
      {
        name: "settings-profile",
        path: "profile",
        component: () => import('./profile-0Y41EgCl.mjs')
      },
      {
        name: "settings-change_email",
        path: "change_email",
        component: () => import('./change_email-ChQYcj7W.mjs')
      },
      {
        name: "settings-change_password",
        path: "change_password",
        component: () => import('./change_password-BtBQPAhg.mjs')
      }
    ]
  },
  {
    name: "students",
    path: "/students",
    component: () => import('./students-B3t-TT5N.mjs'),
    children: [
      {
        name: "students-add",
        path: "add",
        component: () => import('./add-DdS5izpt.mjs')
      },
      {
        name: "students-view",
        path: "view",
        component: () => import('./view-DQdiADio.mjs'),
        children: [
          {
            name: "students-view-grades",
            path: "grades",
            component: () => import('./grades-CqngMdiT.mjs')
          },
          {
            name: "students-view-students_table",
            path: "students_table",
            component: () => import('./students_table-CJcMoyzR.mjs')
          },
          {
            name: "students-view-behavioral_issues",
            path: "behavioral_issues",
            component: () => import('./behavioral_issues-DVb6Bvoi.mjs')
          }
        ]
      },
      {
        name: "students-id-edit_student",
        path: ":id()/edit_student",
        component: () => import('./edit_student-DA79ck7q.mjs')
      },
      {
        name: "students-id-add_grades_report",
        path: ":id()/add_grades_report",
        component: () => import('./add_grades_report-TEyCl1M6.mjs')
      },
      {
        name: "students-id-edit_grades_report",
        path: ":id()/edit_grades_report",
        component: () => import('./edit_grades_report-zXOL1hOK.mjs')
      },
      {
        name: "students-id-add_behavioral_issue",
        path: ":id()/add_behavioral_issue",
        component: () => import('./add_behavioral_issue-DxIMLqz4.mjs')
      },
      {
        name: "students-id-edit_behavioral_issue",
        path: ":id()/edit_behavioral_issue",
        component: () => import('./edit_behavioral_issue-Bwgqx2AP.mjs')
      }
    ]
  },
  {
    name: "teachers",
    path: "/teachers",
    component: () => import('./teachers-Bn_sXBcv.mjs'),
    children: [
      {
        name: "teachers-add",
        path: "add",
        component: () => import('./add-DWTl7VDF.mjs')
      },
      {
        name: "teachers-view",
        path: "view",
        component: () => import('./view-CuGdTAGg.mjs'),
        children: [
          {
            name: "teachers-view-loans",
            path: "loans",
            component: () => import('./loans-BjNWqvy7.mjs')
          },
          {
            name: "teachers-view-absence",
            path: "absence",
            component: () => import('./absence-YDU-FPYt.mjs')
          },
          {
            name: "teachers-view-teachers_table",
            path: "teachers_table",
            component: () => import('./teachers_table-DdE5Jk_W.mjs')
          },
          {
            name: "teachers-view-behavioral_issues",
            path: "behavioral_issues",
            component: () => import('./behavioral_issues-DwyaQ0xz.mjs')
          }
        ]
      },
      {
        name: "teachers-id-add_loan",
        path: ":id()/add_loan",
        component: () => import('./add_loan-BOogssfC.mjs')
      },
      {
        name: "teachers-id-edit_loan",
        path: ":id()/edit_loan",
        component: () => import('./edit_loan-Bkx9M5cH.mjs')
      },
      {
        name: "teachers-id-edit_teacher",
        path: ":id()/edit_teacher",
        component: () => import('./edit_teacher-BdOToup0.mjs')
      },
      {
        name: "teachers-id-add_absence_report",
        path: ":id()/add_absence_report",
        component: () => import('./add_absence_report-D2-1UNjh.mjs')
      },
      {
        name: "teachers-id-edit_absence_report",
        path: ":id()/edit_absence_report",
        component: () => import('./edit_absence_report-B8iHMkj1.mjs')
      },
      {
        name: "teachers-id-add_behavioral_issue",
        path: ":id()/add_behavioral_issue",
        component: () => import('./add_behavioral_issue-ClaScG5E.mjs')
      },
      {
        name: "teachers-id-edit_behavioral_issue",
        path: ":id()/edit_behavioral_issue",
        component: () => import('./edit_behavioral_issue-C_WfS2Bd.mjs')
      }
    ]
  },
  {
    name: "classes-add",
    path: "/classes/add",
    component: () => import('./add-ByAwT393.mjs')
  },
  {
    name: "drivers-add",
    path: "/drivers/add",
    component: () => import('./add-DlQaWstl.mjs')
  },
  {
    name: "plans",
    path: "/plans",
    component: () => import('./index-BwEclTzJ.mjs')
  },
  {
    name: "classes-view",
    path: "/classes/view",
    component: () => import('./view-bq3zI8pE.mjs'),
    children: [
      {
        name: "classes-view-quran_classes",
        path: "quran_classes",
        component: () => import('./quran_classes-D2bfI5SD.mjs')
      },
      {
        name: "classes-view-academic_classes",
        path: "academic_classes",
        component: () => import('./academic_classes-CcQTpGqF.mjs')
      }
    ]
  },
  {
    ...
    component: () => import('./callback-9zRfJ2ir.mjs')
  },
  {
    name: "drivers",
    path: "/drivers",
    component: () => import('./index-D-etHiLc.mjs')
  },
  {
    name: "classes-id-edit_class",
    path: "/classes/:id()/edit_class",
    component: () => import('./edit_class-DG4IJKsS.mjs')
  },
  {
    name: "drivers-id-edit_driver",
    path: "/drivers/:id()/edit_driver",
    component: () => import('./edit_driver-Dvb8edVy.mjs')
  }
];
...
const layouts = {
  auth: defineAsyncComponent(() => import('./auth-BH5m6Ctu.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-CzcA1y9I.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CK8hpp-1.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BsdXxmjS.mjs'));
...
export { usePortal as A, isArrayOfArray as B, get as C, compare as D, omit as E, _sfc_main$8 as F, pickLinkProps as G, _sfc_main$9 as H, _export_sfc as _, __nuxt_component_0$2 as a, useAppConfig as b, _sfc_main$b as c, useLocale as d, entry$1 as default, _sfc_main$7 as e, __nuxt_component_0 as f, useRoute as g, useSupabaseUser as h, _sfc_main$a as i, useFormField as j, useState as k, useToast as l, formBusInjectionKey as m, navigateTo as n, formInputsInjectionKey as o, formLoadingInjectionKey as p, formOptionsInjectionKey as q, inputIdInjectionKey as r, formFieldInjectionKey as s, tv as t, useHead as u, useButtonGroup as v, useComponentIcons as w, looseToNumber as x, useNuxtApp as y, useAvatarGroup as z };
