...
import { l as level_options, q as quran_classes_options, d as class_group_options, e as class_floor_options, f as class_wing_options } from './constants-CI-Eb238.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const onSubmit = async () => {
      ...
      navigateTo({
        name: isAcademic ? "classes-view-academic_classes" : "classes-view-quran_classes"
      });
    };
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_USelect, {
                          items: isAcademic ? unref(level_options) : unref(quran_classes_options),
                  ...
                  _push3(ssrRenderComponent(_component_UButton, {
                    ...
                    color: "secondary",
                    loading: isAcademic ? unref(academicClassesStore).loading : unref(quranClassesStore).loading,
                    label: "\u0625\u0636\u0627\u0641\u0629"
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/classes/add.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=add-ByAwT393.mjs.map
