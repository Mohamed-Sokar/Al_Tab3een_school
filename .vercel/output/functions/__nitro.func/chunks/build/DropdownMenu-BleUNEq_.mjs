...
import { b as useAppConfig, E as omit, t as tv, d as useLocale, A as usePortal, B as isArrayOfArray, c as _sfc_main$b, i as _sfc_main$a, C as get, F as _sfc_main$8, G as pickLinkProps, H as _sfc_main$9 } from './server.mjs';
          ...
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, item.slot || "item", {
              ...
              ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : "item-leading", {
                ...
                if (item.loading) {
                  ...
                  _push2(ssrRenderComponent(_sfc_main$a, mergeProps({
                    ...
                    class: __props.ui.itemLeadingAvatar({ class: [(_g = __props.uiOverride) == null ? void 0 : _g.itemLeadingAvatar, (_h = item.ui) == null ? void 0 : _h.itemLeadingAvatar], active })
                  }), null, _parent2, _scopeId));
                } else {
                  _push2(`<!---->`);
                }
              ...
              if (unref(get)(item, props.labelKey) || !!slots[item.slot ? `${item.slot}-label` : "item-label"]) {
                _push2(`<span class="${ssrRenderClass(__props.ui.itemLabel({ class: [(_a = __props.uiOverride) == null ? void 0 : _a.itemLabel, (_b = item.ui) == null ? void 0 : _b.itemLabel], active }))}"${_scopeId}>`);
                ...
                if (item.target === "_blank" && __props.externalIcon !== false) {
                  _push2(ssrRenderComponent(_sfc_main$b, {
                    ...
                    class: __props.ui.itemLabelExternalIcon({ class: [(_c = __props.uiOverride) == null ? void 0 : _c.itemLabelExternalIcon, (_d = item.ui) == null ? void 0 : _d.itemLabelExternalIcon], color: item == null ? void 0 : item.color, active })
                  }, null, _parent2, _scopeId));
                } else {
                  _push2(`<!---->`);
                }
              ...
              _push2(`<span class="${ssrRenderClass(__props.ui.itemTrailing({ class: [(_e = __props.uiOverride) == null ? void 0 : _e.itemTrailing, (_f = item.ui) == null ? void 0 : _f.itemTrailing] }))}"${_scopeId}>`);
              ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                ...
                if ((_a2 = item.children) == null ? void 0 : _a2.length) {
                  ...
                  _push2(`<span class="${ssrRenderClass(__props.ui.itemTrailingKbds({ class: [(_e2 = __props.uiOverride) == null ? void 0 : _e2.itemTrailingKbds, (_f2 = item.ui) == null ? void 0 : _f2.itemTrailingKbds] }))}"${_scopeId}><!--[-->`);
              ...
              renderSlot(_ctx.$slots, item.slot || "item", {
                ...
                return [
                  ...
                  unref(get)(item, props.labelKey) || !!slots[item.slot ? `${item.slot}-label` : "item-label"] ? (openBlock(), createBlock("span", {
                    key: 0,
                    class: __props.ui.itemLabel({ class: [(_a = __props.uiOverride) == null ? void 0 : _a.itemLabel, (_b = item.ui) == null ? void 0 : _b.itemLabel], active })
                  }, [
                  ...
                  createVNode("span", {
                    class: __props.ui.itemTrailing({ class: [(_e = __props.uiOverride) == null ? void 0 : _e.itemTrailing, (_f = item.ui) == null ? void 0 : _f.itemTrailing] })
                  }, [
                    renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                      ...
                      var _a2, _b2, _c2, _d2, _e2, _f2;
                      return [
                        ((_a2 = item.children) == null ? void 0 : _a2.length) ? (openBlock(), createBlock(_sfc_main$b, {
                          key: 0,
                          name: childrenIcon.value,
                          class: __props.ui.itemTrailingIcon({ class: [(_b2 = __props.uiOverride) == null ? void 0 : _b2.itemTrailingIcon, (_c2 = item.ui) == null ? void 0 : _c2.itemTrailingIcon], color: item == null ? void 0 : item.color, active })
            ...
            ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(__props.sub ? unref(DropdownMenu).SubContent : unref(DropdownMenu).Content), mergeProps({
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  ...
                  _push3(`<div role="presentation" class="${ssrRenderClass(__props.ui.viewport({ class: (_a = props.ui) == null ? void 0 : _a.viewport }))}"${_scopeId2}><!--[-->`);
                          ...
                          ssrRenderList(group, (item, index) => {
                            ...
                            if (item.type === "label") {
                              _push4(ssrRenderComponent(unref(DropdownMenu).Label, {
                                class: __props.ui.label({ class: [(_a3 = __props.uiOverride) == null ? void 0 : _a3.label, (_b2 = item.ui) == null ? void 0 : _b2.label, item.class] })
                              }, {
                              ...
                              _push4(ssrRenderComponent(unref(DropdownMenu).Separator, {
                                class: __props.ui.separator({ class: [(_c = __props.uiOverride) == null ? void 0 : _c.separator, (_d = item.ui) == null ? void 0 : _d.separator, item.class] })
                              }, null, _parent4, _scopeId3));
                            } else if ((_e = item == null ? void 0 : item.children) == null ? void 0 : _e.length) {
                                ...
                                default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                  ...
                                  if (_push5) {
                                    _push5(ssrRenderComponent(unref(DropdownMenu).SubTrigger, {
                                      ...
                                      class: __props.ui.item({ class: [(_a4 = __props.uiOverride) == null ? void 0 : _a4.item, (_b3 = item.ui) == null ? void 0 : _b3.item, item.class], color: item == null ? void 0 : item.color })
                                    }, {
                                    ...
                                    return [
                                      createVNode(unref(DropdownMenu).SubTrigger, {
                                        ...
                                        disabled: item.disabled,
                                        "text-value": unref(get)(item, props.labelKey),
                                        class: __props.ui.item({ class: [(_c2 = __props.uiOverride) == null ? void 0 : _c2.item, (_d2 = item.ui) == null ? void 0 : _d2.item, item.class], color: item == null ? void 0 : item.color })
                                      }, {
                                        default: withCtx(() => [
                                          createVNode(unref(ReuseItemTemplate), {
                                            item,
                                      ...
                                      default: withCtx(({ active, ...slotProps }, _push6, _parent6, _scopeId5) => {
                                        ...
                                        if (_push6) {
                                          _push6(ssrRenderComponent(_sfc_main$9, mergeProps({ ref_for: true }, slotProps, {
                                            class: __props.ui.item({ class: [(_a4 = __props.uiOverride) == null ? void 0 : _a4.item, (_b3 = item.ui) == null ? void 0 : _b3.item, item.class], color: item == null ? void 0 : item.color, active })
                                          }), {
                                          ...
                                          return [
                                            createVNode(_sfc_main$9, mergeProps({ ref_for: true }, slotProps, {
                                              class: __props.ui.item({ class: [(_c2 = __props.uiOverride) == null ? void 0 : _c2.item, (_d2 = item.ui) == null ? void 0 : _d2.item, item.class], color: item == null ? void 0 : item.color, active })
                                            }), {
                                              default: withCtx(() => [
                                                createVNode(unref(ReuseItemTemplate), {
                                                  item,
                  ...
                  return [
                    ...
                    createVNode("div", {
                      role: "presentation",
                      class: __props.ui.viewport({ class: (_b = props.ui) == null ? void 0 : _b.viewport })
                    }, [
              ...
              (openBlock(), createBlock(resolveDynamicComponent(__props.sub ? unref(DropdownMenu).SubContent : unref(DropdownMenu).Content), mergeProps({
                ...
                default: withCtx(() => {
                  ...
                  return [
                    ...
                    createVNode("div", {
                      role: "presentation",
                      class: __props.ui.viewport({ class: (_a = props.ui) == null ? void 0 : _a.viewport })
                    }, [
                      (openBlock(true), createBlock(Fragment, null, renderList(groups.value, (group, groupIndex) => {
                        var _a2;
                        return openBlock(), createBlock(unref(DropdownMenu).Group, {
                          ...
                          default: withCtx(() => [
                            (openBlock(true), createBlock(Fragment, null, renderList(group, (item, index) => {
                              ...
                              return openBlock(), createBlock(Fragment, {
                                ...
                                item.type === "label" ? (openBlock(), createBlock(unref(DropdownMenu).Label, {
                                  key: 0,
                                  class: __props.ui.label({ class: [(_a3 = __props.uiOverride) == null ? void 0 : _a3.label, (_b = item.ui) == null ? void 0 : _b.label, item.class] })
                                }, {
                                  default: withCtx(() => [
                                    createVNode(unref(ReuseItemTemplate), {
                                      item,
                                  ...
                                  default: withCtx(() => {
                                    ...
                                    return [
                                      createVNode(unref(DropdownMenu).SubTrigger, {
                                        ...
                                        disabled: item.disabled,
                                        "text-value": unref(get)(item, props.labelKey),
                                        class: __props.ui.item({ class: [(_a4 = __props.uiOverride) == null ? void 0 : _a4.item, (_b2 = item.ui) == null ? void 0 : _b2.item, item.class], color: item == null ? void 0 : item.color })
                                      }, {
                                        default: withCtx(() => [
                                          createVNode(unref(ReuseItemTemplate), {
                                            item,
                                  ...
                                  default: withCtx(() => [
                                    createVNode(_sfc_main$8, mergeProps({ ref_for: true }, unref(pickLinkProps)(item), { custom: "" }), {
                                      default: withCtx(({ active, ...slotProps }) => {
                                        ...
                                        return [
                                          createVNode(_sfc_main$9, mergeProps({ ref_for: true }, slotProps, {
                                            class: __props.ui.item({ class: [(_a4 = __props.uiOverride) == null ? void 0 : _a4.item, (_b2 = item.ui) == null ? void 0 : _b2.item, item.class], color: item == null ? void 0 : item.color, active })
                                          }), {
                                            default: withCtx(() => [
                                              createVNode(unref(ReuseItemTemplate), {
                                                item,
...
//# sourceMappingURL=DropdownMenu-BleUNEq_.mjs.map
