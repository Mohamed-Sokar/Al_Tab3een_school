...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "quran_classes",
  __ssrInlineRender: true,
  setup(__props) {
    const quranClassesStore = useQuranClassesStore();
    const numberedClasses = computed(
      () => quranClassesStore.classesWithStudentsCount.map((_class, index) => ({
        ..._class,
        rowNumber: index + 1
      }))
    );
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/classes/view/quran_classes.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=quran_classes-D2bfI5SD.mjs.map
