...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const form = ref();
    const reportId = Array.isArray(route.params.id) ? route.params.id[0] : (_a = route.params.id) != null ? _a : "";
    ...
    const state = reactive({
      reason: targetedReport == null ? void 0 : targetedReport.reason,
      date: targetedReport == null ? void 0 : targetedReport.date,
      excuse_status: targetedReport == null ? void 0 : targetedReport.excuse_status
    });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/teachers/[id]/edit_absence_report.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=edit_absence_report-B8iHMkj1.mjs.map
