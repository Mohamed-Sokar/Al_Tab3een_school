...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const loanId = route.params.id instanceof Array ? route.params.id[0] : (_a = route.params.id) != null ? _a : 0;
    const targetedLoan = teachersStore.getSpesificTeacherLoan(+loanId);
    const schema = object({
      amount: number().required("\u0642\u064A\u0645\u0629 \u0627\u0644\u0633\u0644\u0641\u0629 \u0645\u0637\u0644\u0648\u0628\u0629")
    });
    const state = reactive({
      amount: targetedLoan == null ? void 0 : targetedLoan.amount
    });
    const onSubmit = () => {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_UButton, {
                    ...
                    color: "secondary",
                    onClick: ($event) => ("navigateTo" in _ctx ? _ctx.navigateTo : unref(navigateTo))({ name: "teachers-view-loans" }),
                    label: "\u0625\u0644\u063A\u0627\u0621"
                  }, null, _parent3, _scopeId2));
                  _push3(`</div>`);
                } else {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/teachers/[id]/edit_loan.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=edit_loan-Bkx9M5cH.mjs.map
