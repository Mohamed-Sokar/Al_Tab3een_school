...
export const useEmployeeAdministrativeIssues = defineStore(
  "employeeAdministrativeIssues",
  () => {
    // init
    ...
    const fetchReports = async (
      ...
      try {
        ...
        let query = client
          .from("employees_administrative_issues")
          .select(
            `id, employee_id, created_at, description,
